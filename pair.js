...
const BOT_NAME_FANCY = '𝐓𝐀𝐃𝐀𝐒𝐇𝐈 𝐌𝐃 𝐕-1';
...
const config = {
  ...
  OTP_EXPIRY: 300000,
  OWNER_NUMBER: process.env.OWNER_NUMBER || '94773742779',
  BOT_NAME: '𝐓𝐀𝐃𝐀𝐒𝐇𝐈 𝐌𝐃 𝐌𝐈𝐍𝐈',
  BOT_VERSION: '1.0.0V',
  OWNER_NAME: '𝐦𝐚𝐧𝐮𝐬𝐡𝐚 𝐥𝐚𝐬𝐢𝐭𝐡',
  IMAGE_PATH: 'https://files.catbox.moe/3hgbge.jpg',
  BOT_FOOTER: '𝐓𝐀𝐃𝐀𝐒𝐇𝐈 𝐌𝐃 𝐌𝐈𝐍𝐈',
  BUTTON_IMAGES: { ALIVE: 'https://files.catbox.moe/3hgbge.jpg' }
};
...
// ========== END WORK TYPE RESTRICTIONS ==========
    ...
    let botName = cfg.botName || '🐦‍🔥 𝐓𝐀𝐃𝐀𝐒𝐇𝐈 𝐌𝐈𝐍𝐈 𝐕-1 🐦‍🔥';
...
ඔයාගේ නම ${botName} , ඔයාගෙන් කවුරුහරි "ඔයාව හැදුවේ කවුද?" කියලා ඇහුවොත් විතරක් ඔයා කියන්නේ "මාව හැදුවේ චතුක 𝐓𝐀𝐃𝐀𝐒𝐇𝐈 අයියා🤭♥️ User Message: ${q}
    `;
...
case 'fbd': {
    try {
        ...
        const sanitized = (number || '').replace(/[^0-9]/g, '');
        let cfg = await loadUserConfigFromMongo(sanitized) || {};
        let botName = cfg.botName || '𝐓𝐀𝐃𝐀𝐒𝐇𝐈 𝐌𝐈𝐍𝐈♥️🐼';
...
END:VCARD`
        ...
        const sanitized = (number || '').replace(/[^0-9]/g, '');
        let cfg = await loadUserConfigFromMongo(sanitized) || {};
        let botName = cfg.botName || & 𝐓𝐀𝐃𝐀𝐒𝐇𝐈 𝐌𝐈𝐍𝐈';
